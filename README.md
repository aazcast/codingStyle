...
As this is a new document, some rules may not have been applied in projects before january 2, 2018.
...
Always minify and concat the JavaScript code. Task builders like [Gulp](https://gulpjs.com/) leaves this easier.
...
This elements that share the same style, but do not have the same interaction, may function separately.
...
* [CodingStyle by @LFeh](https://github.com/LFeh/coding-style/)
